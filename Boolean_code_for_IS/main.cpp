...
#define ARROW_LENGTH 0.5

#define Grid_3D 7
double gridmarks[Grid_3D] = {0, 0.15, 0.25, 0.5, 0.75, 0.85, 1};
//double gridmarks[Grid_3D] = {0, 0.2, 0.5, 0.8, 1};
//double gridmarks[Grid_3D] = {0, 0.5, 1};
//double gridmarks[Grid_3D] = {0.05, 0.5, 0.7, 0.95};
//double gridmarks[Grid_3D] = {0, 0.1, 0.2, 0.3, 0.95};
//double gridmarks[Grid_3D] = {0, 0.1, 0.2, 0.5, 0.7, 0.8, 0.95};
// double gridmarks[Grid_3D] = {0.05, 0.95};
...
#include "Run_Virtual_Exp_Options_v2.h"
...
#define Systemic_Damage 104
#define Phenotype_Change_in_Mutants_Across_Phase_Space 105
#define Async_Phenotype_Change_in_Mutants_Across_Phase_Space 106
#define AsyncBias_Phenotype_Change_in_Mutants_Across_Phase_Space 107
...
unsigned int get_Exp_Code (string w){
    ...
    if (w == "Systemic_Damage")  return Systemic_Damage;
    if (w == "Phenotype_Change_in_Mutants_Across_Phase_Space")  return Phenotype_Change_in_Mutants_Across_Phase_Space;
    if (w == "Async_Phenotype_Change_in_Mutants_Across_Phase_Space")  return Async_Phenotype_Change_in_Mutants_Across_Phase_Space;
    if (w == "AsyncBias_Phenotype_Change_in_Mutants_Across_Phase_Space")  return AsyncBias_Phenotype_Change_in_Mutants_Across_Phase_Space;
   return 0;
}
      ...
      //  printf("GSE_line = %s\n",GSE_line); getchar();
        if (strlen(tagnow) > 0) {
            switch (get_Exp_Code(tagnow)) {
                ...
                case Systemic_Damage: run_Systemic_Damage(PD,GSE_line); break;
                case Phenotype_Change_in_Mutants_Across_Phase_Space: run_Phenotype_Change_in_Mutants_Across_Phase_Space(PD,GSE_line,-1); break;
                case Async_Phenotype_Change_in_Mutants_Across_Phase_Space: run_Phenotype_Change_in_Mutants_Across_Phase_Space(PD,GSE_line,0); break;
                case AsyncBias_Phenotype_Change_in_Mutants_Across_Phase_Space: run_Phenotype_Change_in_Mutants_Across_Phase_Space(PD,GSE_line,ASSYNC_BIAS); break;
...
int main (int argc, const char * argv[])
{
  ...
  //    run_InSilico_Experimetnal_Package("EMT_Mechanosensing_TGFbeta", "VirtualExp_1.txt");
    //   run_InSilico_Experimetnal_Package("MiDAS_only", "VirtualExp_1.txt");
 //   run_InSilico_Experimetnal_Package("DNA_damage_Senescence", "VirtualExp_1.txt");
 //   run_InSilico_Experimetnal_Package("EMT_Mechanosensing_TGFbeta_BMP4", "VirtualExp_1.txt");
//    run_InSilico_Experimetnal_Package("EMT_Mechanosensing_TGFbeta_BMP4_v2", "VirtualExp_1.txt");
 
    run_InSilico_Experimetnal_Package("EMT_Mechanosensing_TGFbeta_BMP4_v3_YAP_SMAD158", "VirtualExp_now.txt");
    
//    run_InSilico_Experimetnal_Package("MiDAS_Cell_Cycle_Arrests_Apoptosis", "VirtualExp_midASnow.txt");
//    run_InSilico_Experimetnal_Package("MiDAS_Cell_Cycle_Arrests_Apoptosis", "VirtualExp_33.txt");

//    run_InSilico_Experimetnal_Package("NPC_Neuron_Spy1", "VirtualExp_1.txt");

    //   run_InSilico_Experimetnal_Package("Sizek_PI3K_CellCycle_Apoptosis", "VirtualExp_1.txt");
    //run_InSilico_Experimetnal_Package("Deritei_Regan_Cell_Cycle", "VirtualExp_1.txt");
    //run_InSilico_Experimetnal_Package("Yeast_Apoptosis", "VirtualExp_1.txt");
//    run_InSilico_Experimetnal_Package("NPC_Neuron", "VirtualExp_1.txt");
